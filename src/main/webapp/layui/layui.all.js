...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    A.prototype.config = {limit: 10, loading: !0, cellMinWidth: 60}, A.prototype.render = function () {
        ...
        return c.key = s.id || s.index, d.cache[c.key] = u, r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">无数据</div>')) : (m(), void(s.page && (c.page = n, c.count = o, s.page = t.extend({
